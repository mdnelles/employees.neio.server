...
import { add, edit, remove, list, details } from '../routes/EmployeeRoutes';
...
describe('Employees Tests', () => {
  ...
  it('should add a new employee', async () => {
    ...
    expect(bcrypt.hash).toHaveBeenCalledWith(req.body.password, 10, expect.any(Function));
  ...
  it('should return details of an employee', async () => {
    ...
    const deptEmpsData = [{ emp_no: 1, dept_no: 'DEPT001', dept_name: 'Department 1' }];
